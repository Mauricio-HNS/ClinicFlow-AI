...
class _MessagesScreenState extends State<MessagesScreen> {
  final List<_ChatItem> _chats = <_ChatItem>[
    _ChatItem(title: 'Sofa retrô', preview: 'Ainda esta disponivel?', time: '2m', opened: false),
    _ChatItem(title: 'Studio Sol RH', preview: 'Seu perfil combina com a vaga.', time: '14m', opened: false),
    _ChatItem(title: 'Mercado Lavapies', preview: 'Podemos marcar entrevista?', time: '32m', opened: true),
    _ChatItem(title: 'Cozinha completa', preview: 'Aceita retirada hoje?', time: '1h', opened: true),
  ];
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.forum_outlined, color: AppColors.primaryEnd),
                      ),
                  ...
                  Wrap(
                    ...
                    runSpacing: 8,
                    children: [
                      _TopPill(label: 'Nao lidas: $_unreadCount', active: _unreadCount > 0),
          ...
          if (_chats.isEmpty) {
            return GlassContainer(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Text('Nenhuma conversa no momento.', style: Theme.of(context).textTheme.titleMedium),
          ...
          return Dismissible(
            ...
            onDismissed: (_) {
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Conversa com "${chat.title}" apagada.')),
              );
            },
            child: InkWell(
              borderRadius: BorderRadius.circular(18),
              ...
              child: GlassContainer(
                ...
                tint: unread ? AppColors.surface.withValues(alpha: 0.94) : AppColors.surface,
                boxShadow: [
                  BoxShadow(
                ...
                child: Row(
                  children: [
                    Container(
                      ...
                      height: 44,
                      decoration: BoxDecoration(
                        color: unread ? ledColor.withValues(alpha: 0.16) : AppColors.surface.withValues(alpha: 0.48),
                      ...
                      child: Icon(
                        ...
                        color: unread ? const Color(0xFF15803D) : AppColors.primary,
                      ),
                    ),
                    const SizedBox(width: 12),
                    Expanded(
                    ...
                    Text(
                      chat.time,
                      style: Theme.of(context).textTheme.bodySmall?.copyWith(
                            color: unread ? const Color(0xFF166534) : AppColors.textMuted,
                    ...
                    Icon(
                      ...
                      size: 18,
                      color: unread ? const Color(0xFF166534) : AppColors.textMuted.withValues(alpha: 0.8),
                    ),
                  ],
                ),
              ),
      ...
      builder: (sheetContext) {
        return Padding(
          ...
          child: Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Responder ${chat.title}', style: Theme.of(sheetContext).textTheme.titleLarge),
                  ...
                  onPressed: () {
                    if (message.trim().isEmpty) {
                      ScaffoldMessenger.of(sheetContext).showSnackBar(
                        const SnackBar(content: Text('Escreva uma mensagem para responder.')),
                      );
                      return;
                    }
                    Navigator.pop(sheetContext);
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text('Resposta enviada para ${chat.title}.')),
                    );
                  },
...
class _TopPill extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: active ? accent.withValues(alpha: 0.14) : Colors.white.withValues(alpha: 0.45),
        borderRadius: BorderRadius.circular(999),
        border: Border.all(
          color: active ? accent.withValues(alpha: 0.55) : Colors.white.withValues(alpha: 0.74),
        ),
        boxShadow: active
            ? [
                BoxShadow(
