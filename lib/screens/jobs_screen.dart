...
class _JobsScreenState extends State<JobsScreen> {
  ...
  List<Job> get _filteredJobs {
    ...
    return _jobs.where((job) {
      ...
      if (_selectedTypes.isNotEmpty && !_selectedTypes.contains(job.type)) {
        return false;
      }
                ...
                children: [
                  ...
                  AnimatedContainer(
                    ...
                    child: SwitchListTile(
                      ...
                      onChanged: (value) =>
                          setModalState(() => tempRemote = value),
                    ),
                  ),
  ...
  void _openPublishJobSheet(BuildContext context) {
    ...
    var companyPhone = '';
    var location = '';
    var useApproxRegion = false;
    var approxRadiusMeters = 300.0;
    var salary = '';
                      ...
                      TextFormField(
                        ...
                        decoration:
                            _publishInputDecoration(
                              ...
                              hint: 'Ex: Madrid Centro, Chamartín',
                      ...
                      Wrap(
                        ...
                        children: [
                          ChoiceChip(
                            ...
                            selected: location.trim().isEmpty,
                            onSelected: (_) =>
                                setSheetState(() => location = ''),
                          ),
                          ChoiceChip(
                            label: const Text('Região aproximada'),
                            selected: useApproxRegion,
                            onSelected: (selected) =>
                                setSheetState(() => useApproxRegion = selected),
                          ),
                        ],
                      ),
                      if (useApproxRegion) ...[
                        ...
                        GlassContainer(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Exibir somente região aproximada (até ${approxRadiusMeters.round()} m)',
                                style: Theme.of(
                                  sheetContext,
                                ).textTheme.bodySmall,
                              ),
                              Slider(
                                value: approxRadiusMeters,
                                min: 100,
                                max: 300,
                                divisions: 4,
                                label: '${approxRadiusMeters.round()} m',
                                onChanged: (value) => setSheetState(
                                  () => approxRadiusMeters = value,
                                ),
                              ),
                            ],
                          ),
                            ...
                            child: Wrap(
                              ...
                              children: [
                                ChoiceChip(
                                  ...
                                  onSelected: (_) =>
                                      setSheetState(() => isRemote = false),
                                ),
                                ChoiceChip(
                                  label: const Text('Remota'),
                                  selected: isRemote == true,
                                  onSelected: (_) =>
                                      setSheetState(() => isRemote = true),
                                ),
                              ],
                            ),
                          ),
                      ...
                      SizedBox(
                        ...
                        child: GradientButton(
                          onPressed: () {
                            ...
                            final normalizedLocation = isRemote == true
                                ? 'Remoto'
                                : jobLocation.isEmpty
                                ? 'Local não informado'
                                : useApproxRegion
                                ? '$jobLocation (região aproximada · até ${approxRadiusMeters.round()} m)'
                                : jobLocation;
                            ...
                            if (!_isValidSinglePhone(jobCompanyPhone)) {
                              ScaffoldMessenger.of(sheetContext).showSnackBar(
                                const SnackBar(
                                  content: Text(
                                    'Informe apenas 1 celular válido da empresa.',
                                  ),
                                ),
                              );
                              return;
                            ...
                            ScaffoldMessenger.of(context)
                              ...
                              ..showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'Vaga "$jobTitle" publicada com sucesso.',
                                  ),
                                ),
                              );
                          },
  ...
  void _showOnlyNewTodayAndScroll() {
    setState(() => _onlyNewToday = true);
                ...
                child: Column(
                  ...
                  children: [
                      ...
                      child: Row(
                        children: [
                          _JobShortcutChip(
                            ...
                            onTap: () =>
                                setState(() => _onlyRemote = !_onlyRemote),
                          ),
                        ...
                        children: [
                          if (_onlyRemote)
                            InputChip(
                              ...
                              onDeleted: () =>
                                  setState(() => _onlyRemote = false),
                            ),
                          if (_onlyWithPrice)
                            InputChip(
                              label: const Text('Com salário'),
                              onDeleted: () =>
                                  setState(() => _onlyWithPrice = false),
                            ),
                          if (_onlyNewToday)
                            InputChip(
                              label: const Text('Novas hoje'),
                              onDeleted: () =>
                                  setState(() => _onlyNewToday = false),
                            ),
                          ..._selectedTypes.map(
                            (type) => InputChip(
                              label: Text(type),
                    ...
                    _MicroCard(
                      ...
                      onTap: _showOnlyNewTodayAndScroll,
                    ),
                    const SizedBox(height: 10),
                    Align(
                      alignment: Alignment.centerLeft,
                ...
                child: GradientButton(
                  onPressed: () {
                    ...
                    if (name.isEmpty || phone.isEmpty) {
                      ScaffoldMessenger.of(sheetContext).showSnackBar(
                        const SnackBar(
                          content: Text('Nome e celular são obrigatórios.'),
                        ),
                      );
                      return;
                    }
                    if (!_isValidSinglePhone(phone)) {
                      ScaffoldMessenger.of(sheetContext).showSnackBar(
                        const SnackBar(
                          content: Text(
                            'Informe um celular válido (apenas 1 número).',
                          ),
                        ),
                      );
                      return;
